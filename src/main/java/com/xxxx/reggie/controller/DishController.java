...
public class DishController {
    ...
    public R<String> status(Long[] ids,@PathVariable Integer sid) {
        LambdaUpdateWrapper<Dish> updateWrapper=new LambdaUpdateWrapper<>();
        updateWrapper.in(Dish::getId, Arrays.asList(ids)).set(Dish::getStatus,sid);
...
//    }
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        List<DishDto> dishDtoList = list.stream().map((item) -> {
            ...
            dishDtoWrapper.eq(DishFlavor::getDishId,dishId);
            //select * from dish_flavor where dish_id=?
            List<DishFlavor> dishFlavors = dishFlavorService.list(dishDtoWrapper);
